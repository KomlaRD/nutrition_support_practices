...
plot_one <- ggplot(data = nutrition_assessment, aes(nutrition_assessment)) +
  geom_bar(position = "dodge") +
  labs(title = "Routine practice of screening or assessment", x="Nutrition assessment", y="Frequency") +  theme_ggstatsplot() +
  facet_wrap(~ profession_doctor_nurse) + theme(axis.text.x = element_text(angle = 45, hjust = 1))

plot_two <- ggplot(data = nutrition_assessment, aes(profession_assessment), fill = profession_assessment) +
  geom_bar(position = "dodge") +
  labs(title = "Professional who performs assessment", x="Profession", y="Frequency") +  theme_ggstatsplot() + 
  scale_x_discrete(labels=c('Dietitian', 'Medical doctor', 'Critical care nurse', 'NA')) +
  facet_wrap(~ profession_doctor_nurse) + theme(axis.text.x = element_text(angle = 45, hjust = 1))

plot_one <- plot_one + coord_flip()
plot_two <- plot_two + coord_flip()
plot_one / plot_two
```
...
plot_three <- ggplot(data = decision, aes(nutrition_protocol)) +
  geom_bar(position = "dodge") +
  labs(title = "Formal nutrition protocol", x="Nutrition protocol", y="Frequency") +  theme_ggstatsplot() +
  facet_wrap(~ profession_doctor_nurse) + theme(axis.text.x = element_text(angle = 45, hjust = 1))

plot_four <- ggplot(data = decision, aes(fluid_volume_decision)) +
  geom_bar(position = "dodge") +
  labs(title = "Determination of fluid volume", x="Profession", y="Frequency") +  theme_ggstatsplot() + 
  facet_wrap(~ profession_doctor_nurse) + theme(axis.text.x = element_text(angle = 45, hjust = 1))

plot_five <- ggplot(data = decision, aes(decide_route)) +
  geom_bar(position = "dodge") +
  labs(title = "Route of nutrition support", x="Decision about route", y="Frequency") +  theme_ggstatsplot() +
  facet_wrap(~ profession_doctor_nurse) + theme(axis.text.x = element_text(angle = 45, hjust = 1))

plot_six <- ggplot(data = decision, aes(nutrition_support_team)) +
  geom_bar(position = "dodge") +
  labs(title = "Formal nutrition support team", x="Profession", y="Frequency") +  theme_ggstatsplot() + 
  facet_wrap(~ profession_doctor_nurse) + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
plot_three / plot_four / plot_five / plot_six 
```
