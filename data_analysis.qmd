...
plot_one <- ggplot(nutrition_assessment_percentage, aes(y = nutrition_assessment, x = percentage)) +
  ...
  geom_text(aes(label = sprintf("%.1f%%", percentage)), vjust = 1.5, nudge_y = 0.25) +
...
plot_three <- plot_three + coord_flip() 
plot_four <- plot_four + coord_flip() 
plot_five <- plot_five + coord_flip() 
plot_six <- plot_six + coord_flip() 
...
p1 <- ggplot(nutrition_tools_percentage, aes(y = nutrition_tools, x = percentage)) +
  ...
  geom_text(aes(label = sprintf("%.1f%%", percentage)), nudge_x = 0.7, size = 4) +
...
p2 <- ggplot(nutrition_req_percentage, aes(y = nutrition_requirement, x = percentage)) +
  ...
  geom_text(aes(label = sprintf("%.1f%%", percentage)), nudge_x = 0.5, size = 4) +
...
generate_percentage_plot <- function(data, y_col, x_col, title, y_labels, caption = NULL) {
  ...
  p <- ggplot(data, aes_string(y = y_col, x = "percentage")) +  # Use 'percentage' instead of 'n'
    geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
    geom_text(aes(label = sprintf("%.1f%%", percentage)), nudge_x = 0.5, size = 4) +  # Label with formatted percentage
...
p4 <- generate_percentage_plot(
  ...
  'basis_en',
  'n',
  'Basis for EN decision',
  c('Clinical judgment', 'Not sure', "Professional experience",  'Published guidelines')
)

p5 <- generate_percentage_plot(
...
p6 <- generate_percentage_plot(
  feed_tolerance_frequency,
  'feed_tolerance_en',
  'n',
  'Frequency of monitoring feed tolerance',
  c('Every 4-6 hours until EN is established', 'Every 4-6 hours throughout ICU stay', "Never",
    'No standard', "Once daily", "No response"),
...
#   geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
#   geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
#   labs (y = "Criteria to commence EN", x = "Respondents", title = "Criteria to commence EN (A)",
...
#   geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
#   geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
#   labs (y = "Monitoring EN", x = "Respondents", title = "Methods for monitoring EN (A)",
...
total_sum_p8 <- sum(timing_pn_frequency$n)
...
p8 <- create_percentage_plot(timing_pn_frequency, timing_pn_frequency$n, "timing_pn", total_sum_p8, "Timing of PN", c('After 7 days if EN unsuccessful', 'As soon as clinically indicated', "Immediately in malnourished patients", 'Within 24 hours of admission', "No standard", "Within 3 days if EN unsuccessful", "No response"), caption_text = "EN = Enteral nutrition")
p9 <- create_percentage_plot(monitoring_pn_frequency, monitoring_pn_frequency$n, "monitoring_pn", total_sum_p9, "Methods for monitoring PN (B)", c('Clinical signs/symptoms of intolerance', 'Compliance with nutrition goals', "Compliance with PN protocol", 'Compliance with prescribed product', "Compliance with compliance rate", "No response/Null responses"), caption_text = "PN = Parenteral nutrition")
...
#   geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
#   geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
#   labs (y = "Commence PN", x = "Respondents", title = "Criteria to commence PN (B)",
...
#   geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
#   geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
#   labs (y = "Monitoring PN", x = "Respondents", title = "Methods for monitoring PN (B)",
