...
ggsave("figures/combined_plot_criteria.pdf", combined_plot_citeria, width = 10, height = 5, dpi = 600)
ggsave("figures/combined_plot_monitoring.pdf", combined_plot_monitoring, width = 10, height = 5, dpi = 600)
```
