...
p3 <- ggplot(commence_en_frequency, aes(y = commence_en, x = n)) +
  geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
  geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
  labs (y = "Criteria to commence EN", x = "Frequency", title = "Criteria to commence EN in the ICU",
...
p4 <- ggplot(basis_en_frequency, aes(y = basis_en, x = n)) +
  geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
  geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
  labs (y = "Basis for EN decision", x = "Frequency", title = "Basis for EN decision") + 
...
p5 <- ggplot(monitoring_en_frequency, aes(y = methods_monitoring_en, x = n)) +
  geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
  geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
  labs (y = "Monitoring EN", x = "Frequency", title = "Methods for monitoring EN",
...
p6 <- ggplot(feed_tolerance_frequency, aes(y = feed_tolerance_en, x = n)) +
  geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
  geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
  labs (y = "Frequency of monitoring feed tolerance", x = "Frequency", title = "Frequency of monitoring feed tolerance",
...
p7 <- ggplot(commence_pn_frequency, aes(y = commence_pn, x = n)) +
  geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
  geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
  labs (y = "Commence PN", x = "Frequency", title = "Criteria to commence PN",
...
p8 <- ggplot(timing_pn_frequency, aes(y = timing_pn, x = n)) +
  geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
  geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
  labs (y = "Timing pn", x = "Frequency", title = "Timing of PN",
        caption = "EN = Enteral nutrition") +
...
p9 <- ggplot(monitoring_pn_frequency, aes(y = monitoring_pn, x = n)) +
  geom_bar(stat = "identity", fill = "#0072B2", color = "#0072B2", width = 0.6) +
  geom_text(aes(label = n), nudge_x = 0.5, size = 4) +
  labs (y = "Monitoring PN", x = "Frequency", title = "Methods for monitoring PN",
