...
# Save plot
ggsave("criteria_en.pdf", p3, width = 10, height = 5, dpi = 600)
ggsave("basis_en.pdf", p4, width = 10, height = 5, dpi = 600)
ggsave("monitoring_en.pdf", p5, width = 10, height = 5, dpi = 600)
ggsave("feed_tolerance.pdf", p6, width = 10, height = 5, dpi = 600)
```
...
# Save plot
ggsave("figures/criteria_en.pdf", p7, width = 10, height = 5, dpi = 600)
ggsave("figures/basis_en.pdf", p8, width = 10, height = 5, dpi = 600)
ggsave("figures/monitoring_en.pdf", p9, width = 10, height = 5, dpi = 600)
```
