...
```{r import-datasets}
# Full clean dataset
nss <- import(here("data","nss_clean.RData"))

# Subset dataset
## Demographics
demographics <- import(here("data","demographics.RData"))
en <- import(here("data","enteral_nutrition.RData"))
mcqs <- import(here("data","mcqs.csv"))
nutrition_assessment <- import(here("data","nutrition_assessment.RData"))
ons <- import(here("data","oral_nutrition_supplement.RData"))
pn <- import(here("data","parenteral_nutrition.RData"))
skills <- import(here("data","skills.RData"))
decision <- import(here("data","decision.RData"))
```
